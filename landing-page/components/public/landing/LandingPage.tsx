...
const PASSOS = [
  ...
  },
  {
    ...
    descricao:
      "Nessa prova cega, o sistema errou sobre o aluno passar ou não passar em 5,4% dos casos — ou seja, acertou o veredito em mais de 94 de cada 100 alunos. É esse número, medido contra gente de verdade, que aparece na sua tela.",
    acento: {
      borderTop: "border-t-[#002147]",
      text: "text-[#002147]",
      chip: "bg-[#002147]/5",
