...
const FEATURES_PUBLICAS = [
  {
    ...
    detalhe: "um modelo prevê a Etapa 3 · A1 e A2 saem por aritmética exata",
  },
  {
  ...
  },
  {
    ...
    detalhe: "séries históricas oficiais do Cebraspe, etapa a etapa",
  },
];
...
const PASSOS = [
  ...
  {
    numero: "02",
    titulo: "O modelo prevê uma coisa só",
    descricao:
      "Um único modelo prevê o Argumento da sua terceira etapa. Os Argumentos das duas primeiras não são previstos: saem por aritmética exata das notas que você digitou.",
  },
  {
    numero: "03",
        ...
        <header className="relative z-10 text-[#002147] pt-16 pb-0 sm:pt-24">
          <div className="relative z-10 max-w-6xl mx-auto px-6">
            <div className="max-w-3xl">
              ...
              >
                {[
                  ["1", "número previsto — o Argumento da Etapa 3"],
                  ["11", "sinais do seu histórico que entram no modelo"],
