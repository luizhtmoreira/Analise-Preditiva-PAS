...
"""As três que o Cebraspe normaliza separadamente na Parte 1. O Aluno declara a dele
(ticket 04 §5.3): agrupar as três embute viés sistemático contra quem fez espanhol ou
francês. Vivem aqui, no módulo mais fundo, para que não existam duas listas."""
...
class Parte1(Mapping[str, ValorLingua], ABC):
    ...
    uma língua leia igual nos dois casos. O que distingue as formas é o **tipo**, nunca o
    número de chaves — as duas têm três. `misturada` é constante de classe, derivada do tipo e
    incapaz de divergir dele; existe para quem prefere o predicado ao `isinstance`.
    """

    misturada: ClassVar[bool]
...
class ExamStats:
    ...
    # Parte 1 numa das duas formas acima — o Edital nunca publica um valor único por língua
