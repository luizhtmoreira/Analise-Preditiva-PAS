...
- **`origem` sem default, obrigando as 24 entradas a declarar**: descartado — este ticket é expand puro e as 24 entradas ficam intocadas; o risco de uma entrada derivada nascer marcada como `EDITAL` por esquecimento fica contido porque elas vêm de um construtor só, não de literais escritos à mão.
